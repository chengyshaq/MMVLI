...
from model.model.view_block import ViewBlock
from model.model.simm_model import SIMM_Model
from model.model.train_simm_model import Train_SIMM_Model
...
def main_simm_model_train(features, labels, args,
    ...
    optimizer = optim.AdamW(simm_model.parameters(), lr=0.001, weight_decay=weight_decay)
